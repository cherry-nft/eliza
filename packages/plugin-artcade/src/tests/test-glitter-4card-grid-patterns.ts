...
export const glitter4cardGridPatterns = [
    {
        type: "game_mechanic",
        pattern_name: "Interactive Card Grid with Memory Game Effects",
        user_id: "glitter-4card-grid",
        agent_id:
            "/Users/sherchaudhary/eliza/packages/plugin-artcade/embeddings/templates/glitter-4card-grid.html",
        content: {
            html: `<main class="game-grid">
            <div class="card">
            ...
            * {
            ...
            js: `class Pixel {
                ...
                draw() {
                    const centerOffset =
                        this.maxSizeInteger * 0.5 - this.size * 0.5;
            ...
            \`;
                ...
                animate(fnName) {
                    ...
                    this.timePrevious =
                        timeNow - (timePassed % this.timeInterval);
            ...
            context:
                "A responsive grid system for card-based memory games with interactive hover effects and sparkle animations",
            metadata: {
                type: "game_mechanic",
                theme: "dark",
                gameType: "memory",
                interactions: ["hover", "click", "match"],
                colors: {
                    background: "#09090b",
                    foreground: "#e3e3e3",
                    surface1: "#101012",
        ...
        room_id:
            "game_mechanic_memory_card_grid_responsive_dark_theme_hover_effects_glitter_animation_web_component_custom_elements_canvas_pixel_art",
    },
];
